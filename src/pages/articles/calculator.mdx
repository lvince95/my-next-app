...
export const meta = {
  author: 'Vincent Lim',
  date: '2023-02-03',
  title: 'Implementing the Arithmetic Expression Calculator',
  description:
    'This article goes into some detail about how the calculator was implemented',
};

export default (props) => <ArticleLayout meta={meta} {...props} />;

The Arithmetic Expression Calculator is designed to accept an input that will always consist of numbers and operators separated by spaces. Let us dive right into the implementation of the calculator used in this application.
...
- ## result: `+operandStack[0].toFixed(2)`
...
For a regex to parse this input properly, a regex Lookbehind needs to be implemented. Essentially, we need the regex to check the preceding token whenever it encounters a `-`.
