...
- [Unit tests and the test data used](https://github.com/lvince95/my-next-app/tree/main/src/features/deposit/utils/__tests__)
- [\[OLD\] Prisma schema to define the database models](https://github.com/lvince95/my-next-app/blob/main/prisma/schema.prisma)
- [\[OLD\] Cypress e2e tests](https://github.com/lvince95/my-next-app/blob/main/cypress/e2e/deposit.cy.ts)
